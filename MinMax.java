public class MinMax {
    ...
    public void addNode(int data) {
        ...
        if (head == null) {
            ...
            tail = newNode;
            // As it is the last node, tail's next will point to null
            tail.next = null;
        }
    }

    // minimumNode() will find out the minimum value node in the list
    public int minimumNode() {
        ...
        if (head == null) {
            ...
            while (current != null) {
                ...
                // Then, replace the value of min with the current node's data
                if (min > current.data)
                    min = current.data;
    ...
    // maximumNode() will find out the maximum value node in the list
    public int maximumNode() {
        ...
        if (head == null) {
            ...
            max = head.data;
            // If the value of max is lesser than the current's data
            // Then, replace the value of max with the current node's data
            while (current != null) {
                if (current.data > max)
                    max = current.data;
                current = current.next;
